        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-6">
              ...
              Based in Shenzhen, delivering innovation since 2020.
            </p>
            <div className="flex gap-3">
              ...
              <a href="#" aria-label="TikTok" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-primary-500 transition-colors">
